...
{
  url: 'http://data.cityofnewyork.us/resource/h9gi-nx95.json?$select=zip_code,sum(number_of_persons_killed)%20as%20total&$group=zip_code&$limit=' + LIMIT + '&$order=total%20DESC&$$app_token=' + APPTOKEN,
  saveKey: 'zipCodes'
},
{
  url: 'http://data.cityofnewyork.us/resource/h9gi-nx95.json?$select=borough,sum(number_of_persons_killed)%20as%20total&$group=borough&$limit=' + LIMIT + '&$order=total%20DESC&$$app_token=' + APPTOKEN,
  saveKey: 'boroughs'
},
{
  url: 'http://data.cityofnewyork.us/resource/h9gi-nx95.json?$select=date,sum(number_of_persons_killed)%20as%20total&$group=date&$limit=' + LIMIT + '&$order=total%20DESC&$$app_token=' + APPTOKEN,
  saveKey: 'deadlyDays'
}];
