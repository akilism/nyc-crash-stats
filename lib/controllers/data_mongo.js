...
// var end = new Date();
// getDateRangeTotals('crashes', start, end, false).then(function (result) {
//   console.log(result);
//   process.exit();
// });

// fetchCrashes('crashes', {'time': '0:05'}).then(function (result) {
//   console.log(result.total_accidents);
//   process.exit();
// });
...
var addCrashes = function (crashes, collectionName) {
  mongoConnect(connectionString).then(function (db) {
    ...
    collection.insert(_.filter(_.map(crashes, transformCrash), 'unique_key'), {continueOnError: true, safe: true, fullResult: false}, function (err, docs) {
...
module.exports = {
  ...
  getDateRangeTotals:getDateRangeTotals,
